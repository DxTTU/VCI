    ...
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col justify-between items-center p-4 md:p-8 select-none font-sans">
      ...
      <main className="w-full max-w-md my-8">
        <div className="bg-white border border-neutral-300 p-6 md:p-8 space-y-6 relative">
          ...
          <div className="grid grid-cols-2 border border-neutral-200 p-0.5 bg-neutral-50 text-xs font-sans font-semibold">
            <button
              type="button"
              onClick={() => {
                setActiveTab('signin');
          ...
          {activeTab === 'signin' && step === 'credentials' && (
            <form onSubmit={handleInitiateSignIn} className="space-y-4">
              ...
              <div>
                ...
                <span className="text-[10px] font-sans text-neutral-400 block mt-1">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full mt-2 flex items-center justify-center space-x-2 px-4 py-3 bg-neutral-900 hover:bg-VASAVI-blue text-white text-xs font-sans font-semibold tracking-wide uppercase transition-colors duration-200 disabled:opacity-50"
              >
          ...
          {activeTab === 'signin' && step === 'otp' && (
            <form onSubmit={handleVerifyOtpSubmit} className="space-y-4">
              <div className="p-3 bg-neutral-50 border border-neutral-200 text-xs font-sans space-y-1">
                <div className="flex items-center justify-between text-neutral-500">
                  <span className="font-medium">STAGE: 2-STEP VERIFICATION</span>
                ...
                <p className="text-neutral-700 text-xs font-sans font-normal">
                  ...
                  <strong className="font-sans font-semibold text-neutral-900">{maskedEmail}</strong>.
                </p>
              </div>

              {error && (
                <div className="p-3 border border-red-200 bg-red-50 text-red-700 font-sans text-xs font-medium leading-relaxed uppercase tracking-wider">
                  {error}
                </div>
              )}

              {successMsg && !error && (
                <div className="p-2.5 border border-emerald-200 bg-emerald-50 text-emerald-800 font-sans text-xs font-medium">
              ...
              <div>
                ...
                <div className="relative mt-1">
                  <input
                    ...
                    className="w-full text-center text-2xl font-sans font-bold tracking-[0.4em] py-3 px-4 border border-neutral-300 focus:border-VASAVI-blue focus:ring-1 focus:ring-VASAVI-blue outline-none transition-all"
                    autoFocus
                  />
                  <KeyRound className="w-4 h-4 text-neutral-400 absolute right-3 top-3.5 pointer-events-none" />
                </div>
                <span className="text-[10px] font-sans text-neutral-400 block text-center mt-1 font-medium">
              ...
              <button
                ...
                className="w-full mt-2 flex items-center justify-center space-x-2 px-4 py-3 bg-VASAVI-blue hover:bg-VASAVI-blueDark text-white text-xs font-sans font-semibold tracking-wide uppercase transition-colors duration-200 disabled:opacity-50"
              >
              ...
              <div className="pt-3 border-t border-neutral-100 flex items-center justify-between font-sans text-xs font-medium">
                <button
                  type="button"
            ...
            <div className="space-y-4">
              <div className="border border-neutral-200 bg-neutral-50/60 p-4 space-y-3">
                <div className="flex items-center space-x-2">
                  ...
                  <h3 className="text-xs font-sans font-semibold uppercase tracking-wider text-neutral-900">
                ...
                <div className="space-y-1.5 font-sans text-xs text-neutral-600 pt-1 font-medium">
                  <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-VASAVI-blue hover:bg-VASAVI-blueDark text-white text-xs font-sans font-semibold tracking-wide uppercase transition-colors duration-200"
              >
                <UserPlus className="w-3.5 h-3.5 text-VASAVI-gold" />
                <span>Begin Multi-Step Induction Wizard</span>
              </button>

              <p className="text-center font-sans text-[10px] text-neutral-400 font-medium">
