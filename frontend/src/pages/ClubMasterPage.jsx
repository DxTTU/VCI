      ...
      <div className="border border-neutral-200 bg-white p-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-3 self-start sm:self-center">
            <div className="font-mono text-xs text-VASAVI-blue border border-neutral-200 px-3 py-1.5 bg-neutral-50/50">
              TOTAL CLUBS: {clubList.length}
            </div>

            {/* Restricted to Super Admin role: Raw, uppercase monospace button with subtle Lions Gold (#F2A900) hover */}
            {isSuperAdmin && (
              <button
                type="button"
                onClick={() => setIsModalOpen(true)}
                className="font-mono text-xs uppercase tracking-wider px-3.5 py-1.5 border border-neutral-300 hover:border-VASAVI-gold hover:text-VASAVI-goldDark text-neutral-900 transition-all duration-150 bg-white flex items-center space-x-1.5 cursor-pointer select-none"
        ...
        {feedback && (
          <div className="mt-4 p-3 border border-emerald-200 bg-emerald-50/50 text-emerald-800 font-mono text-xs flex items-center justify-between">
            <div className="flex items-center space-x-2">
          ...
          <div className="bg-white border border-gray-200 max-w-lg w-full p-6 sm:p-8 space-y-5 text-left animate-in fade-in zoom-in-95 duration-150 shadow-none">
            ...
            <div className="flex items-center justify-between border-b border-gray-200 pb-3">
              ...
              <button
                ...
                className="font-mono text-xs text-neutral-400 hover:text-neutral-900 px-1 py-0.5"
                title="Close"
              >
                [ X ]
              </button>
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4 text-xs font-mono">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs font-mono p-2.5 border border-gray-200 focus:border-VASAVI-blue outline-none bg-neutral-50/50 focus:bg-white transition-colors"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-xs font-mono uppercase p-2.5 border border-gray-200 focus:border-VASAVI-blue outline-none bg-neutral-50/50 focus:bg-white transition-colors"
                  />
                </div>
              ...
              <div className="pt-4 border-t border-gray-200 flex items-center justify-end space-x-3">
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="px-4 py-2 border border-neutral-900 bg-neutral-900 hover:bg-neutral-800 text-white text-xs font-mono uppercase tracking-wider transition-colors disabled:opacity-40 flex items-center space-x-1.5 cursor-pointer"
                >
